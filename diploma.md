...
TODO: mention problems caused by lack of monitoring
...
TODO: рисунок зберігання даних в еластіку
...
TODO: рисунок фільтрації в кібана дашборді.
...
Також, цю трійку компонентів називають the three pillars (референс TODO). Детальніше про кожен з типів даних є описано в наступних підрозділах.
...
Одним з таких CAPA інструментів в моніторингу розподілених систем є postmortem культура. Вона полягає в тому, аби дослідити інцидент та навчитись від нього. Аби це зробити, першочергово, варто знайти відповіді на наступні питання:
- Що сталось?
