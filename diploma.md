...
Аби вирішити такі проблеми, розробники мусять мати якомога більше інформації стосовно того, що відбувалось в системі, і це дозволить їм сформувати ланцюжок причинно-наслідкових зв'язків, які допоможуть їм знайти джерело проблеми та виправити його. В таких ситуаціях дані - це критична необхідність. Даними можуть бути різноманітні метрики, логи, трейси, тощо. 



Парадоксально, проте чим більшу інвестцію проект робить в оглядовість, тим менше часу доведеться за ним наглядати, тим більше часу можна буде виділити на розробку проекту. 
#### програмні продукти як предмет для відслідковування тривожних тенденцій

і наше завдання в моделюванні оглядовості для розподілених систем полягає в тому, аби створити середовище в якому розробники могли б приймати рішення базуючись на інформації (метрики, сповіщення, тощо) про стан системи. Інакше, якщо при моделюванні цей аспект врахований не буде, то розробникам в певний момент будуть очевидними проблеми із системою (скарги користувачів, витоки даних, некоректно відпрацьовані сценарії, тощо), проте це вже буде занадто пізно - шкода буде зроблена для користувачів та зацікавлених осіб, що може бути критичним. Саме в цьому й полягає основне завдання оглядовості розподілених систем - попередити критичну ситуацію, аби розробники могли прийняти рішення і не дати цьому статися. Саме це й є превентивною безпекою в даному випадку.
...
##### реалізуючи моніторинг та оглядовість
...
Які є етапи  моніторингу. Збір даних, обробка,  аналіз,  презентація.

Які проблеми бувають з кожним етапом і як вони вирішуються в розподілених системах концептуально і на практиці.
...
Презентація:
- Зібрані та проаналізовані дані представляються користувачам в формі, яка є доречною для кожного випадку.
- Розподілена система може створювати величезні обсяги інформації для аналізу та презентації, тим не менше користувач моніторинг системи не в стані справитися з таким когнітивним навантаженням. Тому необхідно оптимізувати ці дані до такого вигляду, що буде релевантним користувачу. Фільтрування даних - це процес мінімізації даних таким чином, що користувач моніторингової системи зможе отримати лише необхідні дані для його рівня сприйняття (напр. отримати інформацію про все, що відбувалось на конкретному сервері за останні 15 хвилин). Варто зазначити, що дані досі лишаються в сховищі даних, проте користувацький інтерфейс показує лише те, що користувач робить запит. 

Тому, дуже важливо мати інструменти візуалізації, що допоможуть зменшити когнітивне навантаження на користувача, не зменшуючи кількість інформації, яку він може оглянути. Більше того, при коректній візуалізації, користувач має можливість ознайомитись з даними за довгі періоди часу, які адаптовані для легшого сприйняття в стислі рамки часу. 
...
В розподілених системах виділяють три основні компоненти, що роблять можливим моніторинг такої системи:
- Логи
- Метрики
- Трейси

Також, цю трійку компонентів називають the three pillars (референс).
