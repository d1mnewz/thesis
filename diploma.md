...
- поміряти скільки по часу це в відсотках займає - наскільки система стає повільнішою від збирання метрик з прометеус наприклад.
